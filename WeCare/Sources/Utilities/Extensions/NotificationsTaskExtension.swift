    ...
    static func getUseCases() -> [NotificationsTask] {
        [
            .init(
                ...
                icon: "ProtecaoSolar",
                voiceIcon: "Pessoa com protetor solar por quase todo o rosto, exceto os olhos",
                ...
                .init(
                    ...
                    icon: "Hidratante",
                    voiceIcon: "Pessoa com hidratante por quase todo o rosto, exceto os olhos",
                ...
                .init(
                    ...
                    icon: "Acessorios",
                    voiceIcon: "Pessoa com acessórios do tipo Chapéu e óculos",
    ...
    static func getMorningTasks() -> [NotificationsTask] {
        [
            .init(
                ...
                icon: "Limpeza",
                voiceIcon: "Pessoa enxaguando todo o rosto para limpeza de pele",
